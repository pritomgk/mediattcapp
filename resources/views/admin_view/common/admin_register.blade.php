...
<head>
    ...
    <title>Mediattc - Admin Register</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 mx-auto">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('admin_register_apply') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputPhone" name="phone" value="+880"

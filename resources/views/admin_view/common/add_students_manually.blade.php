        ...
        <form action="{{ route('add_students_manually_info') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="date" id="course_start" required name="course_start" class="form-control form-control-lg" />
                    @error('course_start')
                    <p class="mb-0 alert alert-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="col-md-6 form-group">
                    ...
                    <input type="date" id="course_end" name="course_end" class="form-control form-control-lg" />
                    @error('course_end')
                    <p class="mb-0 alert alert-danger">{{ $message }}</p>
                    @enderror
                </div>
